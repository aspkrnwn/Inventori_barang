...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-user mx-1"></i><?php echo $username ?></a>
  </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jml_transaksi?></div>
            </div>
            <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-secondary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Data Supplier</div>
  ...
  <div class="alert alert-success" role="alert">
    <h4 class="alert-heading">Hallo!!</h4>
    <p>
      Selamat datang <strong><?php echo $nama_user; ?> </strong> <br> Dihalaman Dashboard <strong>Sanggar Teknik Persada</strong> 
      sebagai <strong><?php echo $hak_akses; ?> </strong>
    </p>
  </div>