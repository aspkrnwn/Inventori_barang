<div class="container-fluid">
	...
	<div class="mt-4">
		<a href="<?php echo base_url('laporan/cetak_laporan_stok_barang/pdf/'.$tanggal_awal.'/'.$tanggal_akhir) ?>" class="btn btn-danger btn-sm btn-icon-split" style="margin-top: -50px">
